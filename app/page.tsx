...
// 新增：用于同步 URL 搜索参数到搜索上下文的组件
function SearchParamsSync({ setSearchKeyword }: { setSearchKeyword: (kw: string) => void }) {
...
export default function Home() {
  ...
  return (
    <>
      {/* 用 Suspense 包裹 SearchParamsSync 以支持 useSearchParams */}
      <Suspense>
        <SearchParamsSync setSearchKeyword={setSearchKeyword} />
      </Suspense>
